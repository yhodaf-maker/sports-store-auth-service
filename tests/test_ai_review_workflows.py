...
def test_all_repository_pr_checks_are_in_authoritative_ci_workflow():
    for required in (
        ...
        "Ruff, pytest, and dependency validation",
        "Gitleaks history and file scan",
        "Checkov Dockerfile validation",
...
def test_orchestrator_only_invokes_review_after_successful_pr_ci():
    assert 'workflows: ["PR Quality and Security"]' in ORCHESTRATOR
